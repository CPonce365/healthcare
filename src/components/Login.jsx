  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white px-4">
      <div className="w-full max-w-xl">
        <h1 className="text-4xl font-bold text-[#20B486] mb-3">Welcome back</h1>
        <p className="text-lg text-gray-600 mb-8">Log in to access your health dashboard.</p>
        ...
        <p className="text-md text-gray-600 mt-8 text-center">
          ...
          <Link to="/signup" className="text-[#20B486] font-semibold">
            Sign up
          </Link>
        </p>
      </div>
